        ...
        <div class="row">
            <div class="col-lg-6> form-group">
                ...
                <form method="post">
                    ...
                    <input type="text" class="form-control" name="stdName" placeholder="ชื่อนักเรียน">
                    <input type="text" class="form-control" name="stdScore" placeholder="คะแนน" require style="margin-top: 20px">
                    <div class="text-right">
                        <button class="btn btn-primary btn-block" style="margin-top: 20px;">ส่ง</button>
                    </div>
                </form> 
            </div>
        </div>
